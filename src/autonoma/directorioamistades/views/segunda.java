 ...
 * @author Asus
 */
public class segunda extends javax.swing.JDialog {

    /**
     * Creates new form segunda
     */
    public segunda(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                segunda dialog = new segunda(new javax.swing.JFrame(), true);
